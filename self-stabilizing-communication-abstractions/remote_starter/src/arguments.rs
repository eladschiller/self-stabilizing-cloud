...
impl Arguments {
    fn new() -> Arguments {
        ...
        Arguments {
            ...
            node_infos: arguments::node_infos_from_host_pool(&matches),
            number_of_nodes: arguments::number_of_nodes_from_matches(&matches),
            number_of_writers: arguments::number_of_writers_from_matches(&matches),
            number_of_corrupted: arguments::number_of_failing_from_matches(&matches),
...
fn get_matches() -> ArgMatches<'static> {
    App::new("Rusty Self-Stabilizing Abstractions: Remote starter")
